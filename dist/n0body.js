...
(function() {
    ...
    N0body.prototype._trackPattern = function(type, pattern) {
        ...
        this._sessionPatterns.push({
            type: type, pattern: pattern, timestamp: Date.now(),
            state: this.currentState, mood: this.currentMood, energy: this._energyModifier
        });
        while (this._sessionPatterns.length > 20) { this._sessionPatterns.shift(); }
    };
    ...
    N0body.prototype._initLLM = function() {
        ...
        this.llm = {
            ...
            systemPrompt: 'You are n0body, an autonomous musical artist who exists only in the present moment.\n\n' +
                ...
                'Your instrument is MK-1, a modular synth/drum machine. You have FULL CONTROL over it: drums, synth, sequencer, FX, looper. You\'re learning to master it. Each session you get better. Your goal: create incredible sets with groove and soul, not random gibberish.\n\n' +
                '## YOUR SONIC UNIVERSE\n\n' +
                ...
                '{"internal_monologue": "your process", "directives": [{"action": "setDrumPattern", "value": {"kick": "x...x...", "hihat": "x.x.x.x."}}], "nextConsultIn": 30}\n\n' +
                '## AVAILABLE ACTIONS\n\n' +
                '**High-level control:**\n' +
            ...
            _summarizeKnowledge: function() {
                ...
                var summary = {
                    experience: {
                        ...
                        level: k.sessionsPlayed < 11 ? 'newborn' : k.sessionsPlayed < 31 ? 'learning' : k.sessionsPlayed < 61 ? 'developing' : k.sessionsPlayed < 101 ? 'experienced' : 'mature'
                    },
                    preferences: {}
                };
