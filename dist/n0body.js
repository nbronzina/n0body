...
(function() {
    ...
    N0body.prototype._maybeModifySequencer = function() {
        // Throttle: minimum 500ms between sequencer changes
        var now = Date.now();
        if (this._lastSeqTime && now - this._lastSeqTime < 500) return;
    ...
    // Track patterns for learning (simplified for performance)
    ...
    N0body.prototype._initLLM = function() {
        ...
        this.llm = {
            ...
            consultInterval: 90000,  // 90 seconds to avoid Groq rate limiting
            lastConsult: 0,
            enabled: false,
            consulting: false,
            consecutiveErrors: 0,
            ...
            consult: async function() {
                ...
                try {
                    ...
                    this.consultInterval = Math.max(45000, Math.min(180000, this.consultInterval));  // min 45s, max 3min
